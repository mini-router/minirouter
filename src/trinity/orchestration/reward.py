...
def extract_choice_letter(text: str) -> str | None:
    ...
    for pat in _CHOICE_PATTERNS:
        ...
        # models self-correct ("the answer is A ... actually the answer is C"),
        # and the final answer comes last (same convention as extract_boxed /
        # extract_last_number / extract_code and this function's fallback below).
